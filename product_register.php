...
<body>
    ...
    <div class="header_title"><h4>Product Registration</h4></div></div>
    ...
    <input type="text" id="industry" name="industry" placeholder="Industry"><br><br>
    <button class="btn" onclick="location.href='https://www.codelportal.com/product_center/'">Submit</button>
